...
void init_simple() {
    uint8_t ip_1[4] = {10,0,0,2};
    uint8_t dmac_1[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x02};
    uint8_t port_1 = 1;

    uint8_t ip_2[4] = {10,0,0,1};
    uint8_t dmac_2[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x01};
    uint8_t port_2 = 0;

    fill_ipv4_fib_lpm_table(ip_1, port_1, dmac_1);
    fill_ipv4_fib_lpm_table(ip_2, port_2, dmac_2);

    fill_sendout_table(port_1, dmac_1);
    fill_sendout_table(port_2, dmac_2);
}
