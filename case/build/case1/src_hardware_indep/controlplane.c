 ...
 uint8_t* field_instance_ethernet_src_mac = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@101
 uint8_t* field_instance_ethernet_src_mac_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@102
 uint8_t* field_instance_ethernet_dst_mac = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@101
 uint8_t* field_instance_ethernet_dst_mac_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@102
 uint8_t* field_instance_ethernet_eth_type = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@101
 uint8_t* field_instance_ethernet_eth_type_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@102
 ...
 uint8_t* field_instance_ip_src_addr = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@101
 uint8_t* field_instance_ip_src_addr_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@102
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@101
 uint8_t* field_instance_ip_dst_addr_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@102
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@101
 uint8_t* field_instance_ip_proto_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@102
 if(strcmp("acl_permit", ctrl_m->action_name)==0) {// sugar@104
 ...
 uint8_t* field_instance_tcp_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@101
 uint8_t* field_instance_tcp_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@102
 uint8_t* field_instance_tcp_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@101
 uint8_t* field_instance_tcp_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@102
 uint8_t* field_instance_tcp_flags = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@101
 uint8_t* field_instance_tcp_flags_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@102
 if(strcmp("acl_permit", ctrl_m->action_name)==0) {// sugar@104
 ...
 uint8_t* field_instance_udp_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@101
 uint8_t* field_instance_udp_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@102
 uint8_t* field_instance_udp_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@101
 uint8_t* field_instance_udp_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@102
 if(strcmp("acl_permit", ctrl_m->action_name)==0) {// sugar@104
 ...
 uint8_t* enable_vlan = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[1])->bitmap;// sugar@108
 memcpy(action.acl_feature_params.enable_vlan, enable_vlan, 1);// sugar@109
 uint8_t* enable_ipv4 = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[2])->bitmap;// sugar@108
 memcpy(action.acl_feature_params.enable_ipv4, enable_ipv4, 1);// sugar@109
 uint8_t* enable_icmp = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[3])->bitmap;// sugar@108
 ...
 uint8_t* field_instance_ethernet_src_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@96
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@96
 ...
 uint8_t* field_instance_ethernet_src_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@96
 uint8_t* field_instance_ethernet_dst_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@96
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@96
 ...
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@96
 ...
 uint8_t* field_instance_ethernet_dst_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@96
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@96
 ...
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_lpm*)ctrl_m->field_matches[0])->bitmap);// sugar@98
 ...
 uint16_t field_instance_ip_dst_addr_prefix_length = ((struct p4_field_match_lpm*)ctrl_m->field_matches[0])->prefix_length;// sugar@99
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@96
 uint8_t* field_instance_standard_metadata_ingress_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@96
 if(strcmp("set_multicast", ctrl_m->action_name)==0) {// sugar@104
 ...
 uint8_t* enable_vlan = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[1])->bitmap;// sugar@134
 memcpy(action.acl_feature_params.enable_vlan, enable_vlan, 1);// sugar@135
 uint8_t* enable_ipv4 = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[2])->bitmap;// sugar@134
 memcpy(action.acl_feature_params.enable_ipv4, enable_ipv4, 1);// sugar@135
 uint8_t* enable_icmp = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[3])->bitmap;// sugar@134
