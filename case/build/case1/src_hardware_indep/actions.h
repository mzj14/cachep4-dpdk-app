 ...
 void action_code_acl_permit(packet_descriptor_t *pd, lookup_table_t **tables, struct action_acl_permit_params);// sugar@52
 ...
 void action_code_acl_feature(packet_descriptor_t *pd, lookup_table_t **tables, struct action_acl_feature_params);// sugar@52
 ...
 void action_code_set_nhop_with_vlan(packet_descriptor_t *pd, lookup_table_t **tables, struct action_set_nhop_with_vlan_params);// sugar@52
 void apply_table_switching(packet_descriptor_t *pd, lookup_table_t** tables);// sugar@49
 void action_code_forwarding(packet_descriptor_t *pd, lookup_table_t **tables, struct action_forwarding_params);// sugar@52
 void apply_table_multicast_routing(packet_descriptor_t *pd, lookup_table_t** tables);// sugar@49
 void action_code_set_multicast(packet_descriptor_t *pd, lookup_table_t **tables, struct action_set_multicast_params);// sugar@52
