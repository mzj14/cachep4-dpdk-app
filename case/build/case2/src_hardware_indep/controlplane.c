 ...
 uint8_t* field_instance_ethernet_src_mac = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_ethernet_src_mac_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 ...
 uint8_t* field_instance_tcp_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_tcp_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 uint8_t* field_instance_tcp_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@105
 uint8_t* field_instance_tcp_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@106
 uint8_t* field_instance_tcp_flags = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@105
 uint8_t* field_instance_tcp_flags_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@106
 if(strcmp("acl_permit", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_udp_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_udp_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 uint8_t* field_instance_udp_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@105
 uint8_t* field_instance_udp_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@106
 if(strcmp("acl_permit", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_ip_src_addr = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_nat_metadata_l4_src_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 ...
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_nat_metadata_l4_dst_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 if(strcmp("on_miss", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_nat_metadata_l4_dst_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[4])->bitmap);// sugar@100
 if(strcmp("on_miss", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@105
 uint8_t* field_instance_ip_proto_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@106
 uint8_t* field_instance_nat_metadata_l4_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->bitmap);// sugar@105
 uint8_t* field_instance_nat_metadata_l4_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->mask);// sugar@106
 uint8_t* field_instance_nat_metadata_l4_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[4])->bitmap);// sugar@105
 uint8_t* field_instance_nat_metadata_l4_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[4])->mask);// sugar@106
 if(strcmp("nop", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_ethernet_dst_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
