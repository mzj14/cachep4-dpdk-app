...
struct action_cache_action_params {// sugar@33
...
struct cache_action {// sugar@39
    int action_id;// sugar@40
    union {// sugar@41
        struct action_cache_action_params cache_action_params;// sugar@44
    };// sugar@45
};// sugar@46
...
void apply_table_cache(packet_descriptor_t *pd, lookup_table_t **tables);// sugar@49
void action_code_cache_block(packet_descriptor_t *pd, lookup_table_t **tables);// sugar@54
void action_code_cache_action(packet_descriptor_t *pd, lookup_table_t **tables,
                              struct action_cache_action_params);// sugar@52
