...
void
action_code_acl_permit(packet_descriptor_t *pd, lookup_table_t **tables, struct action_acl_permit_params);// sugar@54
...
void
action_code_acl_feature(packet_descriptor_t *pd, lookup_table_t **tables, struct action_acl_feature_params);// sugar@54
...
void action_code_rewrite_tcp_src(packet_descriptor_t *pd, lookup_table_t **tables,
                                 struct action_rewrite_tcp_src_params);// sugar@54
void action_code_rewrite_udp_src(packet_descriptor_t *pd, lookup_table_t **tables,
                                 struct action_rewrite_udp_src_params);// sugar@54
...
void action_code_rewrite_tcp_dst(packet_descriptor_t *pd, lookup_table_t **tables,
                                 struct action_rewrite_tcp_dst_params);// sugar@54
void action_code_rewrite_udp_dst(packet_descriptor_t *pd, lookup_table_t **tables,
                                 struct action_rewrite_udp_dst_params);// sugar@54
...
void action_code_rewrite_twice_tcp(packet_descriptor_t *pd, lookup_table_t **tables,
                                   struct action_rewrite_twice_tcp_params);// sugar@54
void action_code_rewrite_twice_udp(packet_descriptor_t *pd, lookup_table_t **tables,
                                   struct action_rewrite_twice_udp_params);// sugar@54
...
void action_code_nop(packet_descriptor_t *pd, lookup_table_t **tables);// sugar@56
void action_code_set_storm_control_meter(packet_descriptor_t *pd, lookup_table_t **tables,
...
void action_code_set_nhop_with_vlan(packet_descriptor_t *pd, lookup_table_t **tables,
                                    struct action_set_nhop_with_vlan_params);// sugar@54
void apply_table_switching(packet_descriptor_t *pd, lookup_table_t **tables);// sugar@51
void
action_code_forwarding(packet_descriptor_t *pd, lookup_table_t **tables, struct action_forwarding_params);// sugar@54
...
void action_code_set_multicast(packet_descriptor_t *pd, lookup_table_t **tables,
                               struct action_set_multicast_params);// sugar@54
