...
void action_code_set_storm_control_meter(packet_descriptor_t *pd, lookup_table_t **tables,
                                         struct action_set_storm_control_meter_params parameters) {// sugar@441
    uint32_t value32, res32, mask32;// sugar@442
    (void) value32;
    (void) res32;
    (void) mask32;// sugar@443
...
void action_code_set_vrf(packet_descriptor_t *pd, lookup_table_t **tables,
                         struct action_set_vrf_params parameters) {// sugar@441
    uint32_t value32, res32, mask32;// sugar@442
    (void) value32;
    (void) res32;
    (void) mask32;// sugar@443
