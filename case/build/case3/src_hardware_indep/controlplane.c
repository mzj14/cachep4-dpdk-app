 ...
 extern void table_ipsg_permit_special_key(packet_descriptor_t* pd, uint8_t* key); // defined in dataplane.c// sugar@31
 ...
 uint8_t field_instance_vrf_metadata_vrf_mask[2],// sugar@47
 ...
 {// sugar@52
     uint8_t key[16];// sugar@53
     uint8_t mask[16];// sugar@55
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(mask+0, field_instance_vrf_metadata_vrf_mask, 2);// sugar@63
 ...
 {// sugar@52
     uint8_t key[11];// sugar@53
     uint8_t mask[11];// sugar@55
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(mask+0, field_instance_vrf_metadata_vrf_mask, 2);// sugar@63
 memcpy(key+2, field_instance_ip_src_addr, 4);// sugar@61
 memcpy(mask+2, field_instance_ip_src_addr_mask, 4);// sugar@63
 memcpy(key+6, field_instance_ip_dst_addr, 4);// sugar@61
 memcpy(mask+6, field_instance_ip_dst_addr_mask, 4);// sugar@63
 memcpy(key+10, field_instance_ip_proto, 1);// sugar@61
 memcpy(mask+10, field_instance_ip_proto_mask, 1);// sugar@63
 ...
 {// sugar@52
     ...
     uint8_t mask[7];// sugar@55
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(mask+0, field_instance_vrf_metadata_vrf_mask, 2);// sugar@63
 memcpy(key+2, field_instance_tcp_src_port, 2);// sugar@61
 memcpy(mask+2, field_instance_tcp_src_port_mask, 2);// sugar@63
 memcpy(key+4, field_instance_tcp_dst_port, 2);// sugar@61
 memcpy(mask+4, field_instance_tcp_dst_port_mask, 2);// sugar@63
 memcpy(key+6, field_instance_tcp_flags, 1);// sugar@61
 memcpy(mask+6, field_instance_tcp_flags_mask, 1);// sugar@63
 ...
 {// sugar@52
     ...
     uint8_t mask[6];// sugar@55
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(mask+0, field_instance_vrf_metadata_vrf_mask, 2);// sugar@63
 memcpy(key+2, field_instance_udp_src_port, 2);// sugar@61
 memcpy(mask+2, field_instance_udp_src_port_mask, 2);// sugar@63
 memcpy(key+4, field_instance_udp_dst_port, 2);// sugar@61
 memcpy(mask+4, field_instance_udp_dst_port_mask, 2);// sugar@63
 ...
 {// sugar@52
     uint8_t key[10];// sugar@53
     uint8_t mask[10];// sugar@55
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(mask+0, field_instance_vrf_metadata_vrf_mask, 2);// sugar@63
 memcpy(key+2, field_instance_ip_src_addr, 4);// sugar@61
 memcpy(mask+2, field_instance_ip_src_addr_mask, 4);// sugar@63
 ...
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(key+2, field_instance_ip_src_addr, 4);// sugar@61
 memcpy(key+6, field_instance_ip_proto, 1);// sugar@61
 memcpy(key+7, field_instance_nat_metadata_l4_src_port, 2);// sugar@61
 ...
 {// sugar@52
     uint8_t key[9];// sugar@53
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(key+2, field_instance_ip_dst_addr, 4);// sugar@61
 memcpy(key+6, field_instance_ip_proto, 1);// sugar@61
 memcpy(key+7, field_instance_nat_metadata_l4_dst_port, 2);// sugar@61
 ...
 {// sugar@52
     uint8_t key[15];// sugar@53
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(key+2, field_instance_ip_src_addr, 4);// sugar@61
 memcpy(key+6, field_instance_ip_dst_addr, 4);// sugar@61
 memcpy(key+10, field_instance_ip_proto, 1);// sugar@61
 memcpy(key+11, field_instance_nat_metadata_l4_src_port, 2);// sugar@61
 memcpy(key+13, field_instance_nat_metadata_l4_dst_port, 2);// sugar@61
 ...
 memcpy(mask+10, field_instance_ip_proto_mask, 1);// sugar@63
 memcpy(key+11, field_instance_nat_metadata_l4_src_port, 2);// sugar@61
 memcpy(mask+11, field_instance_nat_metadata_l4_src_port_mask, 2);// sugar@63
 memcpy(key+13, field_instance_nat_metadata_l4_dst_port, 2);// sugar@61
 memcpy(mask+13, field_instance_nat_metadata_l4_dst_port_mask, 2);// sugar@63
 ...
 void// sugar@40
 ipsg_permit_special_add(// sugar@41
 uint8_t field_instance_ip_src_addr[4],// sugar@44
 uint8_t field_instance_ip_src_addr_mask[4],// sugar@47
 uint8_t field_instance_ip_dst_addr[4],// sugar@44
 uint8_t field_instance_ip_dst_addr_mask[4],// sugar@47
 ...
 uint8_t field_instance_udp_dst_port[2],// sugar@44
 uint8_t field_instance_udp_dst_port_mask[2],// sugar@47
 struct ipsg_permit_special_action action)// sugar@51
 {// sugar@52
     uint8_t key[17];// sugar@53
     uint8_t mask[17];// sugar@55
 ...
 memcpy(key+9, field_instance_tcp_src_port, 2);// sugar@61
 memcpy(mask+9, field_instance_tcp_src_port_mask, 2);// sugar@63
 memcpy(key+11, field_instance_tcp_dst_port, 2);// sugar@61
 memcpy(mask+11, field_instance_tcp_dst_port_mask, 2);// sugar@63
 memcpy(key+13, field_instance_udp_src_port, 2);// sugar@61
 memcpy(mask+13, field_instance_udp_src_port_mask, 2);// sugar@63
 memcpy(key+15, field_instance_udp_dst_port, 2);// sugar@61
 memcpy(mask+15, field_instance_udp_dst_port_mask, 2);// sugar@63
 ternary_add_promote(TABLE_ipsg_permit_special, (uint8_t*)key, (uint8_t*)mask, (uint8_t*)&action);// sugar@84
 }// sugar@85

 void// sugar@87
 ipsg_permit_special_setdefault(struct ipsg_permit_special_action action)// sugar@88
 {// sugar@89
     table_setdefault_promote(TABLE_ipsg_permit_special, (uint8_t*)&action);// sugar@90
 }// sugar@91
 void// sugar@40
 ipsg_add(// sugar@41
 ...
 uint8_t field_instance_ethernet_src_mac[6],// sugar@44
 uint8_t field_instance_ip_src_addr[4],// sugar@44
 struct ipsg_action action)// sugar@51
 {// sugar@52
     uint8_t key[12];// sugar@53
 memcpy(key+0, field_instance_standard_metadata_ingress_port, 2);// sugar@61
 memcpy(key+2, field_instance_ethernet_src_mac, 6);// sugar@61
 memcpy(key+8, field_instance_ip_src_addr, 4);// sugar@61
 exact_add_promote(TABLE_ipsg, (uint8_t*)key, (uint8_t*)&action);// sugar@82
 }// sugar@85

 void// sugar@87
 ipsg_setdefault(struct ipsg_action action)// sugar@88
 {// sugar@89
     table_setdefault_promote(TABLE_ipsg, (uint8_t*)&action);// sugar@90
 }// sugar@91
 void// sugar@40
 storm_control_tbl_add(// sugar@41
 uint8_t field_instance_standard_metadata_ingress_port[2],// sugar@44
 ...
 uint8_t field_instance_ip_dst_addr[4],// sugar@44
 uint8_t field_instance_ip_dst_addr_mask[4],// sugar@47
 struct storm_control_tbl_action action)// sugar@51
 {// sugar@52
 ...
 memcpy(key+2, field_instance_ethernet_dst_mac, 6);// sugar@61
 memcpy(mask+2, field_instance_ethernet_dst_mac_mask, 6);// sugar@63
 memcpy(key+8, field_instance_ethernet_eth_type, 2);// sugar@61
 memcpy(mask+8, field_instance_ethernet_eth_type_mask, 2);// sugar@63
 memcpy(key+10, field_instance_ip_dst_addr, 4);// sugar@61
 memcpy(mask+10, field_instance_ip_dst_addr_mask, 4);// sugar@63
 ternary_add_promote(TABLE_storm_control_tbl, (uint8_t*)key, (uint8_t*)mask, (uint8_t*)&action);// sugar@84
 }// sugar@85

 void// sugar@87
 storm_control_tbl_setdefault(struct storm_control_tbl_action action)// sugar@88
 {// sugar@89
     table_setdefault_promote(TABLE_storm_control_tbl, (uint8_t*)&action);// sugar@90
 }// sugar@91
 void// sugar@40
 port_vlan_to_vrf_add(// sugar@41
 uint8_t field_instance_standard_metadata_ingress_port[2],// sugar@44
 uint8_t field_instance_vlan_vid[2],// sugar@44
 struct port_vlan_to_vrf_action action)// sugar@51
 {// sugar@52
     uint8_t key[4];// sugar@53
 memcpy(key+0, field_instance_standard_metadata_ingress_port, 2);// sugar@61
 memcpy(key+2, field_instance_vlan_vid, 2);// sugar@61
 exact_add_promote(TABLE_port_vlan_to_vrf, (uint8_t*)key, (uint8_t*)&action);// sugar@82
 }// sugar@85
 ...
 memcpy(key+2, field_instance_ethernet_src_mac, 6);// sugar@61
 memcpy(key+8, field_instance_ethernet_dst_mac, 6);// sugar@61
 memcpy(key+14, field_instance_vlan_vid, 2);// sugar@61
 ...
 memcpy(key+0, field_instance_vrf_metadata_vrf, 2);// sugar@61
 memcpy(key+2, field_instance_ethernet_dst_mac, 6);// sugar@61
 memcpy(key+8, field_instance_vlan_vid, 2);// sugar@61
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_vrf_metadata_vrf_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 uint8_t* field_instance_ethernet_src_mac = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@105
 uint8_t* field_instance_ethernet_src_mac_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@106
 uint8_t* field_instance_ethernet_dst_mac = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@105
 uint8_t* field_instance_ethernet_dst_mac_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@106
 uint8_t* field_instance_ethernet_eth_type = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->bitmap);// sugar@105
 uint8_t* field_instance_ethernet_eth_type_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->mask);// sugar@106
 ...
 field_instance_vrf_metadata_vrf,// sugar@119
 field_instance_vrf_metadata_vrf_mask,// sugar@123
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_vrf_metadata_vrf_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 uint8_t* field_instance_ip_src_addr = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@105
 uint8_t* field_instance_ip_src_addr_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@106
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@105
 uint8_t* field_instance_ip_dst_addr_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@106
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->bitmap);// sugar@105
 uint8_t* field_instance_ip_proto_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->mask);// sugar@106
 if(strcmp("acl_permit", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_vrf_metadata_vrf_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 uint8_t* field_instance_tcp_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@105
 uint8_t* field_instance_tcp_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@106
 uint8_t* field_instance_tcp_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@105
 uint8_t* field_instance_tcp_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@106
 uint8_t* field_instance_tcp_flags = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->bitmap);// sugar@105
 uint8_t* field_instance_tcp_flags_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->mask);// sugar@106
 if(strcmp("acl_permit", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_vrf_metadata_vrf_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 uint8_t* field_instance_udp_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@105
 uint8_t* field_instance_udp_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@106
 uint8_t* field_instance_udp_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@105
 uint8_t* field_instance_udp_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@106
 if(strcmp("acl_permit", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* enable_vlan = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[1])->bitmap;// sugar@112
 memcpy(action.acl_feature_params.enable_vlan, enable_vlan, 1);// sugar@113
 uint8_t* enable_ipv4 = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[2])->bitmap;// sugar@112
 memcpy(action.acl_feature_params.enable_ipv4, enable_ipv4, 1);// sugar@113
 uint8_t* enable_icmp = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[3])->bitmap;// sugar@112
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_ip_src_addr = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 uint8_t* field_instance_nat_metadata_l4_src_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[3])->bitmap);// sugar@100
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 uint8_t* field_instance_nat_metadata_l4_dst_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[3])->bitmap);// sugar@100
 if(strcmp("on_miss", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_ip_src_addr = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[3])->bitmap);// sugar@100
 uint8_t* field_instance_nat_metadata_l4_src_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[4])->bitmap);// sugar@100
 uint8_t* field_instance_nat_metadata_l4_dst_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[5])->bitmap);// sugar@100
 if(strcmp("on_miss", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->bitmap);// sugar@105
 uint8_t* field_instance_ip_proto_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->mask);// sugar@106
 uint8_t* field_instance_nat_metadata_l4_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[4])->bitmap);// sugar@105
 uint8_t* field_instance_nat_metadata_l4_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[4])->mask);// sugar@106
 uint8_t* field_instance_nat_metadata_l4_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[5])->bitmap);// sugar@105
 uint8_t* field_instance_nat_metadata_l4_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[5])->mask);// sugar@106
 if(strcmp("nop", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 ...
 void// sugar@95
 ipsg_permit_special_add_table_entry(struct p4_ctrl_msg* ctrl_m) {// sugar@96
 uint8_t* field_instance_ip_src_addr = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_ip_src_addr_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@105
 uint8_t* field_instance_ip_dst_addr_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@106
 uint8_t* field_instance_ip_proto = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@105
 uint8_t* field_instance_ip_proto_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@106
 uint8_t* field_instance_tcp_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->bitmap);// sugar@105
 uint8_t* field_instance_tcp_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->mask);// sugar@106
 uint8_t* field_instance_tcp_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[4])->bitmap);// sugar@105
 uint8_t* field_instance_tcp_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[4])->mask);// sugar@106
 uint8_t* field_instance_udp_src_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[5])->bitmap);// sugar@105
 uint8_t* field_instance_udp_src_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[5])->mask);// sugar@106
 uint8_t* field_instance_udp_dst_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[6])->bitmap);// sugar@105
 uint8_t* field_instance_udp_dst_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[6])->mask);// sugar@106
 if(strcmp("nop", ctrl_m->action_name)==0) {// sugar@108
     struct ipsg_permit_special_action action;// sugar@109
     action.action_id = action_nop;// sugar@110
     debug("Reply from the control plane arrived.\n");// sugar@114
     debug("Adding new entry to ipsg_permit_special with action nop\n");// sugar@115
     ipsg_permit_special_add(// sugar@116
 field_instance_ip_src_addr,// sugar@119
 field_instance_ip_src_addr_mask,// sugar@123
 field_instance_ip_dst_addr,// sugar@119
 field_instance_ip_dst_addr_mask,// sugar@123
 ...
 if(strcmp("ipsg_miss", ctrl_m->action_name)==0) {// sugar@108
     struct ipsg_permit_special_action action;// sugar@109
     action.action_id = action_ipsg_miss;// sugar@110
     debug("Reply from the control plane arrived.\n");// sugar@114
     debug("Adding new entry to ipsg_permit_special with action ipsg_miss\n");// sugar@115
     ipsg_permit_special_add(// sugar@116
 field_instance_ip_src_addr,// sugar@119
 field_instance_ip_src_addr_mask,// sugar@123
 field_instance_ip_dst_addr,// sugar@119
 ...
 void// sugar@95
 ipsg_add_table_entry(struct p4_ctrl_msg* ctrl_m) {// sugar@96
 uint8_t* field_instance_standard_metadata_ingress_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_ethernet_src_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_ip_src_addr = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 if(strcmp("on_miss", ctrl_m->action_name)==0) {// sugar@108
     struct ipsg_action action;// sugar@109
     action.action_id = action_on_miss;// sugar@110
     debug("Reply from the control plane arrived.\n");// sugar@114
     debug("Adding new entry to ipsg with action on_miss\n");// sugar@115
     ipsg_add(// sugar@116
 ...
 void// sugar@95
 storm_control_tbl_add_table_entry(struct p4_ctrl_msg* ctrl_m) {// sugar@96
 uint8_t* field_instance_standard_metadata_ingress_port = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->bitmap);// sugar@105
 uint8_t* field_instance_standard_metadata_ingress_port_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[0])->mask);// sugar@106
 uint8_t* field_instance_ethernet_dst_mac = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->bitmap);// sugar@105
 uint8_t* field_instance_ethernet_dst_mac_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[1])->mask);// sugar@106
 uint8_t* field_instance_ethernet_eth_type = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->bitmap);// sugar@105
 uint8_t* field_instance_ethernet_eth_type_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[2])->mask);// sugar@106
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->bitmap);// sugar@105
 uint8_t* field_instance_ip_dst_addr_mask = (uint8_t*)(((struct p4_field_match_ternary*)ctrl_m->field_matches[3])->mask);// sugar@106
 if(strcmp("nop", ctrl_m->action_name)==0) {// sugar@108
     struct storm_control_tbl_action action;// sugar@109
     action.action_id = action_nop;// sugar@110
     debug("Reply from the control plane arrived.\n");// sugar@114
     debug("Adding new entry to storm_control_tbl with action nop\n");// sugar@115
     storm_control_tbl_add(// sugar@116
 field_instance_standard_metadata_ingress_port,// sugar@119
 ...
 if(strcmp("set_storm_control_meter", ctrl_m->action_name)==0) {// sugar@108
     struct storm_control_tbl_action action;// sugar@109
     action.action_id = action_set_storm_control_meter;// sugar@110
 uint8_t* meter_idx = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[0])->bitmap;// sugar@112
 memcpy(action.set_storm_control_meter_params.meter_idx, meter_idx, 2);// sugar@113
     debug("Reply from the control plane arrived.\n");// sugar@114
     debug("Adding new entry to storm_control_tbl with action set_storm_control_meter\n");// sugar@115
     storm_control_tbl_add(// sugar@116
 field_instance_standard_metadata_ingress_port,// sugar@119
 field_instance_standard_metadata_ingress_port_mask,// sugar@123
 field_instance_ethernet_dst_mac,// sugar@119
 ...
 void// sugar@95
 port_vlan_to_vrf_add_table_entry(struct p4_ctrl_msg* ctrl_m) {// sugar@96
 uint8_t* field_instance_standard_metadata_ingress_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 if(strcmp("set_vrf", ctrl_m->action_name)==0) {// sugar@108
     struct port_vlan_to_vrf_action action;// sugar@109
     action.action_id = action_set_vrf;// sugar@110
 uint8_t* vrf = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[0])->bitmap;// sugar@112
 memcpy(action.set_vrf_params.vrf, vrf, 2);// sugar@113
     debug("Reply from the control plane arrived.\n");// sugar@114
     debug("Adding new entry to port_vlan_to_vrf with action set_vrf\n");// sugar@115
     port_vlan_to_vrf_add(// sugar@116
 field_instance_standard_metadata_ingress_port,// sugar@119
 ...
 uint8_t* field_instance_ethernet_src_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_ethernet_src_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_ethernet_dst_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[3])->bitmap);// sugar@100
 ...
 uint8_t* field_instance_vrf_metadata_vrf = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[0])->bitmap);// sugar@100
 uint8_t* field_instance_ethernet_dst_mac = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 ...
 uint8_t* field_instance_ip_dst_addr = (uint8_t*)(((struct p4_field_match_lpm*)ctrl_m->field_matches[0])->bitmap);// sugar@102
 ...
 uint16_t field_instance_ip_dst_addr_prefix_length = ((struct p4_field_match_lpm*)ctrl_m->field_matches[0])->prefix_length;// sugar@103
 uint8_t* field_instance_vlan_vid = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[1])->bitmap);// sugar@100
 uint8_t* field_instance_standard_metadata_ingress_port = (uint8_t*)(((struct p4_field_match_exact*)ctrl_m->field_matches[2])->bitmap);// sugar@100
 if(strcmp("set_multicast", ctrl_m->action_name)==0) {// sugar@108
 ...
 uint8_t* enable_vlan = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[1])->bitmap;// sugar@138
 memcpy(action.acl_feature_params.enable_vlan, enable_vlan, 1);// sugar@139
 uint8_t* enable_ipv4 = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[2])->bitmap;// sugar@138
 memcpy(action.acl_feature_params.enable_ipv4, enable_ipv4, 1);// sugar@139
 uint8_t* enable_icmp = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[3])->bitmap;// sugar@138
 ...
 void// sugar@130
 ipsg_permit_special_set_default_table_action(struct p4_ctrl_msg* ctrl_m) {// sugar@131
 debug("Action name: %s\n", ctrl_m->action_name);// sugar@132
 if(strcmp("nop", ctrl_m->action_name)==0) {// sugar@134
     struct ipsg_permit_special_action action;// sugar@135
     action.action_id = action_nop;// sugar@136
     debug("Message from the control plane arrived.\n");// sugar@140
     debug("Set default action for ipsg_permit_special with action nop\n");// sugar@141
     ipsg_permit_special_setdefault( action );// sugar@142
 } else// sugar@143
 if(strcmp("ipsg_miss", ctrl_m->action_name)==0) {// sugar@134
     struct ipsg_permit_special_action action;// sugar@135
     action.action_id = action_ipsg_miss;// sugar@136
     debug("Message from the control plane arrived.\n");// sugar@140
     debug("Set default action for ipsg_permit_special with action ipsg_miss\n");// sugar@141
     ipsg_permit_special_setdefault( action );// sugar@142
 } else// sugar@143
 debug("Table setdefault: action name mismatch (%s).\n", ctrl_m->action_name);// sugar@144
 }// sugar@145
 void// sugar@130
 ipsg_set_default_table_action(struct p4_ctrl_msg* ctrl_m) {// sugar@131
 debug("Action name: %s\n", ctrl_m->action_name);// sugar@132
 if(strcmp("on_miss", ctrl_m->action_name)==0) {// sugar@134
     struct ipsg_action action;// sugar@135
     action.action_id = action_on_miss;// sugar@136
     debug("Message from the control plane arrived.\n");// sugar@140
     debug("Set default action for ipsg with action on_miss\n");// sugar@141
     ipsg_setdefault( action );// sugar@142
 } else// sugar@143
 debug("Table setdefault: action name mismatch (%s).\n", ctrl_m->action_name);// sugar@144
 }// sugar@145
 void// sugar@130
 storm_control_tbl_set_default_table_action(struct p4_ctrl_msg* ctrl_m) {// sugar@131
 debug("Action name: %s\n", ctrl_m->action_name);// sugar@132
 if(strcmp("nop", ctrl_m->action_name)==0) {// sugar@134
     struct storm_control_tbl_action action;// sugar@135
     action.action_id = action_nop;// sugar@136
     debug("Message from the control plane arrived.\n");// sugar@140
     debug("Set default action for storm_control_tbl with action nop\n");// sugar@141
     storm_control_tbl_setdefault( action );// sugar@142
 } else// sugar@143
 if(strcmp("set_storm_control_meter", ctrl_m->action_name)==0) {// sugar@134
     struct storm_control_tbl_action action;// sugar@135
     action.action_id = action_set_storm_control_meter;// sugar@136
 uint8_t* meter_idx = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[0])->bitmap;// sugar@138
 memcpy(action.set_storm_control_meter_params.meter_idx, meter_idx, 2);// sugar@139
     debug("Message from the control plane arrived.\n");// sugar@140
     debug("Set default action for storm_control_tbl with action set_storm_control_meter\n");// sugar@141
     storm_control_tbl_setdefault( action );// sugar@142
 } else// sugar@143
 debug("Table setdefault: action name mismatch (%s).\n", ctrl_m->action_name);// sugar@144
 }// sugar@145
 void// sugar@130
 port_vlan_to_vrf_set_default_table_action(struct p4_ctrl_msg* ctrl_m) {// sugar@131
 debug("Action name: %s\n", ctrl_m->action_name);// sugar@132
 if(strcmp("set_vrf", ctrl_m->action_name)==0) {// sugar@134
     struct port_vlan_to_vrf_action action;// sugar@135
     action.action_id = action_set_vrf;// sugar@136
 uint8_t* vrf = (uint8_t*)((struct p4_action_parameter*)ctrl_m->action_params[0])->bitmap;// sugar@138
 memcpy(action.set_vrf_params.vrf, vrf, 2);// sugar@139
     debug("Message from the control plane arrived.\n");// sugar@140
     debug("Set default action for port_vlan_to_vrf with action set_vrf\n");// sugar@141
     port_vlan_to_vrf_setdefault( action );// sugar@142
 } else// sugar@143
 debug("Table setdefault: action name mismatch (%s).\n", ctrl_m->action_name);// sugar@144
 }// sugar@145
 void// sugar@130
 ...
 if (strcmp("ipsg_permit_special", ctrl_m->table_name) == 0)// sugar@152
     ipsg_permit_special_add_table_entry(ctrl_m);// sugar@153
 else// sugar@154
 if (strcmp("ipsg", ctrl_m->table_name) == 0)// sugar@152
     ipsg_add_table_entry(ctrl_m);// sugar@153
 else// sugar@154
 if (strcmp("storm_control_tbl", ctrl_m->table_name) == 0)// sugar@152
     storm_control_tbl_add_table_entry(ctrl_m);// sugar@153
 else// sugar@154
 ...
 if (strcmp("ipsg_permit_special", ctrl_m->table_name) == 0)// sugar@159
     ipsg_permit_special_set_default_table_action(ctrl_m);// sugar@160
 else// sugar@161
 if (strcmp("ipsg", ctrl_m->table_name) == 0)// sugar@159
     ipsg_set_default_table_action(ctrl_m);// sugar@160
 else// sugar@161
 if (strcmp("storm_control_tbl", ctrl_m->table_name) == 0)// sugar@159
     storm_control_tbl_set_default_table_action(ctrl_m);// sugar@160
 else// sugar@161
