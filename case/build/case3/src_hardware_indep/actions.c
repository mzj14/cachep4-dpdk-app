 ...
 extern backend bg;// sugar@25
  ...
  void action_code_no_op(packet_descriptor_t* pd, lookup_table_t** tables ) {// sugar@441
     ...
     (void)value32; (void)res32; (void)mask32;// sugar@443
 }// sugar@453
  ...
  void action_code_acl_drop(packet_descriptor_t* pd, lookup_table_t** tables , struct action_acl_drop_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  value32 = 1;// sugar@146
...
// sugar@449
  ...
  void action_code_acl_permit(packet_descriptor_t* pd, lookup_table_t** tables , struct action_acl_permit_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  value32 = 0;// sugar@146
  MODIFY_INT32_INT32_AUTO(pd, field_instance_acl_metadata_acl_op, value32)// sugar@43
...
// sugar@449
  ...
  void action_code_acl_alert(packet_descriptor_t* pd, lookup_table_t** tables , struct action_acl_alert_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  value32 = 2;// sugar@146
  MODIFY_INT32_INT32_AUTO(pd, field_instance_acl_metadata_acl_op, value32)// sugar@43
...
// sugar@449
  ...
  void action_code_acl_feature(packet_descriptor_t* pd, lookup_table_t** tables , struct action_acl_feature_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
...
// sugar@449
  ...
  void action_code_rewrite_udp_src(packet_descriptor_t* pd, lookup_table_t** tables , struct action_rewrite_udp_src_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
...
// sugar@449
  ...
  void action_code_rewrite_udp_dst(packet_descriptor_t* pd, lookup_table_t** tables , struct action_rewrite_udp_dst_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
...
// sugar@449
  ...
  void action_code_rewrite_tcp_src(packet_descriptor_t* pd, lookup_table_t** tables , struct action_rewrite_tcp_src_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
...
// sugar@449
  ...
  void action_code_rewrite_tcp_dst(packet_descriptor_t* pd, lookup_table_t** tables , struct action_rewrite_tcp_dst_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
...
// sugar@449
  ...
  void action_code_rewrite_twice_udp(packet_descriptor_t* pd, lookup_table_t** tables , struct action_rewrite_twice_udp_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
...
// sugar@449
  ...
  void action_code_rewrite_twice_tcp(packet_descriptor_t* pd, lookup_table_t** tables , struct action_rewrite_twice_tcp_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
...
// sugar@449
  ...
  void action_code_ipsg_miss(packet_descriptor_t* pd, lookup_table_t** tables ) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  value32 = 1;// sugar@146
  MODIFY_INT32_INT32_AUTO(pd, field_instance_ipsg_metadata_ipsg_drop, value32)// sugar@43
// sugar@147
// sugar@449
...
// sugar@449
  ...
  void action_code_set_storm_control_meter(packet_descriptor_t* pd, lookup_table_t** tables , struct action_set_storm_control_meter_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  MODIFY_INT32_BYTEBUF(pd, field_instance_meter_metadata_meter_index, parameters.meter_idx, 2)// sugar@189
// sugar@449
 }// sugar@453

  void action_code_set_vrf(packet_descriptor_t* pd, lookup_table_t** tables , struct action_set_vrf_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  MODIFY_INT32_BYTEBUF(pd, field_instance_vrf_metadata_vrf, parameters.vrf, 2)// sugar@189
// sugar@449
 }// sugar@453
  ...
  void action_code_learning(packet_descriptor_t* pd, lookup_table_t** tables ) {// sugar@441
   ...
   struct type_field_list fields;// sugar@371
    ...
    generate_digest(bg,"learn_list",0,&fields); sleep(1);// sugar@386
// sugar@449
 }// sugar@453
...
// sugar@449
  ...
  void action_code_ucast(packet_descriptor_t* pd, lookup_table_t** tables , struct action_ucast_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  value32 = 2;// sugar@146
  MODIFY_INT32_INT32_AUTO(pd, field_instance_route_metadata_route, value32)// sugar@43
...
// sugar@449
  ...
  void action_code_set_nhop(packet_descriptor_t* pd, lookup_table_t** tables , struct action_set_nhop_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  if(6 < field_desc(pd, field_instance_ethernet_src_mac).bytewidth) {// sugar@193
     ...
     MODIFY_BYTEBUF_BYTEBUF(pd, field_instance_ethernet_src_mac, parameters.src_mac + (6 - field_desc(pd, field_instance_ethernet_src_mac).bytewidth), field_desc(pd, field_instance_ethernet_src_mac).bytewidth)// sugar@196
 }// sugar@197
// sugar@449
  if(6 < field_desc(pd, field_instance_ethernet_dst_mac).bytewidth) {// sugar@193
     ...
     MODIFY_BYTEBUF_BYTEBUF(pd, field_instance_ethernet_dst_mac, parameters.dst_mac + (6 - field_desc(pd, field_instance_ethernet_dst_mac).bytewidth), field_desc(pd, field_instance_ethernet_dst_mac).bytewidth)// sugar@196
 }// sugar@197
// sugar@449
 }// sugar@453

  void action_code_set_nhop_with_vlan(packet_descriptor_t* pd, lookup_table_t** tables , struct action_set_nhop_with_vlan_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
  if(6 < field_desc(pd, field_instance_ethernet_src_mac).bytewidth) {// sugar@193
     MODIFY_BYTEBUF_BYTEBUF(pd, field_instance_ethernet_src_mac, parameters.src_mac, 6);                // sugar@194
...
// sugar@449
  ...
  void action_code_forwarding(packet_descriptor_t* pd, lookup_table_t** tables , struct action_forwarding_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
...
// sugar@449
  ...
  void action_code_set_multicast(packet_descriptor_t* pd, lookup_table_t** tables , struct action_set_multicast_params parameters) {// sugar@441
     uint32_t value32, res32, mask32;// sugar@442
     (void)value32; (void)res32; (void)mask32;// sugar@443
