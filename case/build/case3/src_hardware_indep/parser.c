 ...
 static void// sugar@81
 extract_header_acl_metadata(uint8_t* buf, packet_descriptor_t* pd) {// sugar@82
     pd->headers[header_instance_acl_metadata].pointer = buf;// sugar@83
 }// sugar@90
 
 static void// sugar@81
 extract_header_nat_metadata(uint8_t* buf, packet_descriptor_t* pd) {// sugar@82
     pd->headers[header_instance_nat_metadata].pointer = buf;// sugar@83
 }// sugar@90
 
 static void// sugar@81
 extract_header_ipsg_metadata(uint8_t* buf, packet_descriptor_t* pd) {// sugar@82
     pd->headers[header_instance_ipsg_metadata].pointer = buf;// sugar@83
 }// sugar@90
 
 static void// sugar@81
 extract_header_meter_metadata(uint8_t* buf, packet_descriptor_t* pd) {// sugar@82
     pd->headers[header_instance_meter_metadata].pointer = buf;// sugar@83
 }// sugar@90
 
 static void// sugar@81
 extract_header_vrf_metadata(uint8_t* buf, packet_descriptor_t* pd) {// sugar@82
     pd->headers[header_instance_vrf_metadata].pointer = buf;// sugar@83
 }// sugar@90
...
// sugar@154
 ...
 EXTRACT_INT32_AUTO(pd, field_instance_ip_src_addr, value32)// sugar@135
 pd->fields.field_instance_ip_src_addr = value32;// sugar@136
 pd->fields.attr_field_instance_ip_src_addr = 0;// sugar@137
 EXTRACT_INT32_AUTO(pd, field_instance_ip_dst_addr, value32)// sugar@135
 pd->fields.field_instance_ip_dst_addr = value32;// sugar@136
 pd->fields.attr_field_instance_ip_dst_addr = 0;// sugar@137
...
// sugar@154
 ...
 EXTRACT_INT32_AUTO(pd, field_instance_tcp_src_port, value32)// sugar@135
 pd->fields.field_instance_tcp_src_port = value32;// sugar@136
 pd->fields.attr_field_instance_tcp_src_port = 0;// sugar@137
 EXTRACT_INT32_AUTO(pd, field_instance_tcp_dst_port, value32)// sugar@135
 pd->fields.field_instance_tcp_dst_port = value32;// sugar@136
...
// sugar@154
 ...
 pd->fields.field_instance_udp_src_port = value32;// sugar@136
 pd->fields.attr_field_instance_udp_src_port = 0;// sugar@137
 EXTRACT_INT32_AUTO(pd, field_instance_udp_dst_port, value32)// sugar@135
 pd->fields.field_instance_udp_dst_port = value32;// sugar@136
