 ...
 {// sugar@69
     ...
     if (res != NULL) {// sugar@110
       switch (res->action_id) {// sugar@111
         case action_acl_permit:// sugar@113
           if ((GET_INT32_AUTO(pd, field_instance_acl_metadata_acl_op))==(0)) { return apply_table_switching(pd, tables); } else { return apply_table_storm_control_tbl(pd, tables); }// sugar@114
           break;// sugar@115
         case action_acl_alert:// sugar@113
           if ((GET_INT32_AUTO(pd, field_instance_acl_metadata_acl_op))==(0)) { return apply_table_switching(pd, tables); } else { return apply_table_storm_control_tbl(pd, tables); }// sugar@114
           break;// sugar@115
     ...
     if (res != NULL) {// sugar@110
       switch (res->action_id) {// sugar@111
         case action_get_tcp_information:// sugar@113
           if ((GET_INT32_AUTO(pd, field_instance_nat_metadata_enable_nat))==(1)) { return apply_table_nat_twice(pd, tables); } else { return apply_table_unicast_routing(pd, tables); }// sugar@114
           break;// sugar@115
 ...
 {// sugar@69
     ...
     if (res != NULL) {// sugar@110
       switch (res->action_id) {// sugar@111
         case action_nop:// sugar@113
           if ((GET_INT32_AUTO(pd, field_instance_ipsg_metadata_ipsg_drop))==(0)) { return apply_table_mac_learning(pd, tables); } else {  }// sugar@114
           break;// sugar@115
     ...
     if (res != NULL) {// sugar@110
       switch (res->action_id) {// sugar@111
         case action_ucast:// sugar@113
           if ((GET_INT32_AUTO(pd, field_instance_route_metadata_route))==(1)) { return apply_table_multicast_routing(pd, tables); } else { if ((GET_INT32_AUTO(pd, field_instance_route_metadata_route))==(2)) { if ((GET_INT32_AUTO(pd, field_instance_route_metadata_lan))!=(1)) { return apply_table_port_vlan_to_vrf(pd, tables); } else { if ((GET_INT32_AUTO(pd, field_instance_acl_metadata_acl_op))==(0)) { return apply_table_switching(pd, tables); } else { return apply_table_storm_control_tbl(pd, tables); } } } else { return apply_table_storm_control_tbl(pd, tables); } }// sugar@114
           break;// sugar@115
 ...
 uint32_t calculate_udp_checksum(packet_descriptor_t* pd) {// sugar@134
   ...
   payload_ptr = (((void*)pd->headers[header_instance_udp].pointer) + (pd->headers[header_instance_udp].length));// sugar@202
   res = csum16_add(res, calculate_csum16(payload_ptr, packet_length(pd) - (payload_ptr - ((void*) pd->data))));// sugar@203
 ...
 uint32_t calculate_tcp_checksum(packet_descriptor_t* pd) {// sugar@134
   ...
   uint8_t buffer_1[1] = {0};// sugar@194
   memcpy(buf + ((64) / 8), &buffer_1, 1);// sugar@195
   payload_ptr = (((void*)pd->headers[header_instance_tcp].pointer) + (pd->headers[header_instance_tcp].length));// sugar@202
   res = csum16_add(res, calculate_csum16(payload_ptr, packet_length(pd) - (payload_ptr - ((void*) pd->data))));// sugar@203
   if(pd->headers[header_instance_ip].pointer != NULL) {// sugar@209
     memcpy(buf + ((0) / 8), field_desc(pd, field_instance_ip_src_addr).byte_addr, ((64) / 8));// sugar@213
     memcpy(buf + ((72) / 8), field_desc(pd, field_instance_ip_proto).byte_addr, ((8) / 8));// sugar@213
 ...
 memset(packet_desc->headers[header_instance_standard_metadata].pointer, 0, header_info(header_instance_standard_metadata).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_ethernet].pointer, 0, header_info(header_instance_ethernet).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_ip].pointer, 0, header_info(header_instance_ip).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_tcp].pointer, 0, header_info(header_instance_tcp).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_arp].pointer, 0, header_info(header_instance_arp).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_icmp].pointer, 0, header_info(header_instance_icmp).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_udp].pointer, 0, header_info(header_instance_udp).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_vlan].pointer, 0, header_info(header_instance_vlan).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_acl_metadata].pointer, 0, header_info(header_instance_acl_metadata).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_nat_metadata].pointer, 0, header_info(header_instance_nat_metadata).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_ipsg_metadata].pointer, 0, header_info(header_instance_ipsg_metadata).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_meter_metadata].pointer, 0, header_info(header_instance_meter_metadata).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_vrf_metadata].pointer, 0, header_info(header_instance_vrf_metadata).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_intrinsic_metadata].pointer, 0, header_info(header_instance_intrinsic_metadata).bytewidth * sizeof(uint8_t));// sugar@232
 memset(packet_desc->headers[header_instance_route_metadata].pointer, 0, header_info(header_instance_route_metadata).bytewidth * sizeof(uint8_t));// sugar@232
 }// sugar@233
 void init_headers(packet_descriptor_t* packet_desc) {// sugar@235
 packet_desc->headers[header_instance_standard_metadata] = (header_descriptor_t) { .type = header_instance_standard_metadata, .length = header_info(header_instance_standard_metadata).bytewidth,// sugar@238
 ...
 packet_desc->headers[header_instance_ethernet] = (header_descriptor_t) { .type = header_instance_ethernet, .length = header_info(header_instance_ethernet).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_ethernet).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_ip] = (header_descriptor_t) { .type = header_instance_ip, .length = header_info(header_instance_ip).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_ip).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_tcp] = (header_descriptor_t) { .type = header_instance_tcp, .length = header_info(header_instance_tcp).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_tcp).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_arp] = (header_descriptor_t) { .type = header_instance_arp, .length = header_info(header_instance_arp).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_arp).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_icmp] = (header_descriptor_t) { .type = header_instance_icmp, .length = header_info(header_instance_icmp).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_icmp).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_udp] = (header_descriptor_t) { .type = header_instance_udp, .length = header_info(header_instance_udp).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_udp).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_vlan] = (header_descriptor_t) { .type = header_instance_vlan, .length = header_info(header_instance_vlan).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_vlan).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_acl_metadata] = (header_descriptor_t) { .type = header_instance_acl_metadata, .length = header_info(header_instance_acl_metadata).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_acl_metadata).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_nat_metadata] = (header_descriptor_t) { .type = header_instance_nat_metadata, .length = header_info(header_instance_nat_metadata).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_nat_metadata).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_ipsg_metadata] = (header_descriptor_t) { .type = header_instance_ipsg_metadata, .length = header_info(header_instance_ipsg_metadata).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_ipsg_metadata).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_meter_metadata] = (header_descriptor_t) { .type = header_instance_meter_metadata, .length = header_info(header_instance_meter_metadata).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_meter_metadata).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_vrf_metadata] = (header_descriptor_t) { .type = header_instance_vrf_metadata, .length = header_info(header_instance_vrf_metadata).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_vrf_metadata).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_intrinsic_metadata] = (header_descriptor_t) { .type = header_instance_intrinsic_metadata, .length = header_info(header_instance_intrinsic_metadata).bytewidth,// sugar@238
                               .pointer = malloc(header_info(header_instance_intrinsic_metadata).bytewidth * sizeof(uint8_t)),// sugar@239
                               .var_width_field_bitwidth = 0 };// sugar@240
 packet_desc->headers[header_instance_route_metadata] = (header_descriptor_t) { .type = header_instance_route_metadata, .length = header_info(header_instance_route_metadata).bytewidth,// sugar@238
